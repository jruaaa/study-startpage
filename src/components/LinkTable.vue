...
<table class="table-auto w-full text-sm">
    <tr>
        <td><b>Read</b></td>
        <Link url="https://misd.schoology.com" name="schoology"/>
        <Link url="http://family.mercerisland.wa-k12.net/" name="skyward"/>
    </tr>
    <tr>
        <td><b>Write</b></td>
        <Link url="https://docs.google.com" name="google docs"/>
